...
public class Items {
   ...
   public static final DeferredItem<Item> NETHERWORLD_DUST = ITEMS.register("netherwood_dust", () -> new NetherwoodDustItem(new Properties().stacksTo(64)));
   ...
   @SuppressWarnings("unused")
   public static final DeferredItem<Item> LYE = ITEMS.register("lye", () -> new Item(new Properties().stacksTo(64)));
   ...
   public static final DeferredItem<BlockItem> PERFORATED_SPRITZER = ITEMS.register(
           "perforated_spritzer", () -> new BlockItem(AllModBlocks.PERFORATED_SPRITZER.get(), new Properties())
   );
   ...
   public static final DeferredItem<Item> RUBBER_PADDING = ITEMS.register(
           "rubber_padding", () -> new RubberPaddingBlockItem(AllModBlocks.RUBBER_PADDING.get(), new Properties())
   );
   ...
   public static final DeferredItem<Item> MOLTEN_ROTOR_FURNACE = ITEMS.register(
           "molten_rotor_furnace", () -> new BlockItem(AllModBlocks.MOLTEN_ROTOR_FURNACE.get(), new Item.Properties().stacksTo(64))
   );
   public static final DeferredItem<BlockItem> SULFUR_BLOCK = ITEMS.register(
           "sulfur_block", () -> new BlockItem(AllModBlocks.SULFUR_BLOCK.get(), new Properties())
   );
   public static final DeferredItem<BucketItem> SULFURIC_ACID_BUCKET = ITEMS.register(
           "sulfuric_acid_bucket",
           () -> new BucketItem(AllModFluids.SULFURIC_ACID.get(), new Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1))
   );

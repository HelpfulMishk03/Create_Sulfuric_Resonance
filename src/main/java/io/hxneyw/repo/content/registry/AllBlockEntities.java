...
public class AllBlockEntities {
   ...
   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MoltenRotorBlockEntity>> MOLTEN_ROTOR = BLOCK_ENTITIES.register(
      "molten_rotor", () -> Builder.of(MoltenRotorBlockEntity::new, new Block[]{(Block)AllModBlocks.MOLTEN_ROTOR_FURNACE.get()}).build(null)
   );
   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PerforatedSpritzerBlockEntity>> PERFORATED_SPRITZER = BLOCK_ENTITIES.register(
      "perforated_spritzer", () -> Builder.of(PerforatedSpritzerBlockEntity::new, new Block[]{(Block)AllModBlocks.PERFORATED_SPRITZER.get()}).build(null)
   );
   ...
   private static void registerCapabilities(RegisterCapabilitiesEvent event) {
      event.registerBlockEntity(ItemHandler.BLOCK, MOLTEN_ROTOR.get(), (blockEntity, side) -> blockEntity.fuelHandler);

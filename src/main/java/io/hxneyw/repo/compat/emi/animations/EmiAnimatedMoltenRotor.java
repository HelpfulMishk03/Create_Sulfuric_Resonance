...
public final class EmiAnimatedMoltenRotor extends EmiAnimatedKinetics {

    private HeatLevel heatLevel = HeatLevel.SEETHING;

    public EmiAnimatedMoltenRotor withHeat(HeatLevel heatLevel) {
